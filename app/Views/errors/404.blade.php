    ...
    <div class="relative z-10 space-y-12 max-w-2xl">
        ...
        <div class="space-y-8">
            ...
            <div class="flex flex-wrap justify-center gap-6">
                <a href="{{ $base_url }}/" class="btn-gradient px-12 py-5 rounded-[2rem] font-black text-xl shadow-2xl shadow-indigo-600/20 hover:scale-105 active:scale-95 transition-all">
                    Return to Mission
                </a>
