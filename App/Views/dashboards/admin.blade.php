                    ...
                    @foreach($clubs ?? [] as $club)
                        <div class="glass p-6 rounded-3xl border border-slate-800 relative overflow-hidden group hover:border-blue-500/40 transition-all cursor-pointer"
                            ...
                            <div class="flex justify-between items-start mb-6 relative z-10">
                                ...
                                <div class="flex gap-2" @click.stop>
                                    <button id="formunlleModifier" data-clubid="{{ $club['id_club'] }}"
                                    ...
                                    <a href="./club/supprumer/{{ $club['id_club'] }}"
                        ...
                        <tbody class="divide-y divide-slate-800/50">
                            @foreach($students as $student)
                                <tr class="hover:bg-slate-800/30 transition-colors group">
                                    ...
                                    <td class="py-6">
                                        <span
                                            class="px-3 py-1 rounded-full text-[10px] font-black uppercase {{ $student['club'] === 'None' ? 'bg-slate-800 text-slate-500' : 'bg-blue-600/10 text-blue-400 border border-blue-500/20' }}">
                                            {{ $student['club'] }}
                                        </span>
                                    </td>
                                    <td class="py-6">
    ...
    <script>
        ...
        modufucation.forEach(ele => {
            ele.addEventListener('click', (e) => {
                ...
                fetch(`/Club%20Edge/dashboard/club/modifier/${clubid}`)
                    .then(rep => rep.json())
                    .then(data => {
                        console.log(data);
