    ...
    <div x-show="showEventModal"
        ...
        <div class="glass w-full max-w-xl max-h-[90vh] flex flex-col p-8 md:p-10 rounded-[2.5rem] border border-white/10 relative shadow-2xl"
            ...
            <div class="overflow-y-auto pr-2 custom-scrollbar">
                <form action="{{ $base_url }}/events/store" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-2">Event Cover Image</label>
                        <div class="relative mt-1">
                            <input type="file" name="image_event" accept="image/*"
                                class="w-full bg-slate-900/50 border border-white/10 rounded-2xl px-5 py-4 text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-indigo-500 file:text-white hover:file:bg-indigo-600 cursor-pointer">
                        </div>
                    </div>
