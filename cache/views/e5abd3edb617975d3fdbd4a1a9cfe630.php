        ...
        <div x-show="activeTab === 'overview'" class="space-y-8 animate-fadeIn">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="glass p-6 rounded-2xl border border-slate-800 border-l-4 border-l-blue-500">
                    ...
                    <div class="text-3xl font-bold text-white"><?php echo e(count($registered_events)); ?></div>
                </div>
                <div class="glass p-6 rounded-2xl border border-slate-800 border-l-4 border-l-emerald-500">
                    ...
                    <div class="text-3xl font-bold text-white"><?php echo e($reviews_count); ?></div>
                </div>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-8 relative z-10">
                        ...
                        <div class="flex-grow text-center md:text-left">
                            ...
                            <div class="flex flex-wrap justify-center md:justify-start gap-3">
                                <span class="px-4 py-2 bg-slate-800 border border-slate-700 rounded-xl text-xs font-bold text-slate-300">Member #<?php echo e($_SESSION['user_id']); ?></span>
            ...
            <?php else: ?>
                <div class="glass p-12 rounded-3xl border border-dashed border-slate-700 text-center">
                    ...
                    <a href="<?php echo e($base_url); ?>/universe" class="btn-gradient px-8 py-3 rounded-xl">Explore Clubs</a>
                </div>
            <?php endif; ?>
        </div>
