    ...
    <main class="flex-grow space-y-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="glass p-6 rounded-3xl border border-slate-800 bg-gradient-to-br from-indigo-500/5 to-transparent">
                ...
                <div class="text-3xl font-bold"><?php echo e($stats['total_students']); ?></div>
            </div>
            <div class="glass p-6 rounded-3xl border border-slate-800 bg-gradient-to-br from-yellow-500/5 to-transparent">
                ...
                <div class="text-3xl font-bold text-yellow-500"><?php echo e($my_club['']); ?></div>
            </div>
            <div class="glass p-6 rounded-3xl border border-slate-800 bg-gradient-to-br from-green-500/5 to-transparent">
                ...
                <div class="text-3xl font-bold text-green-500"><?php echo e($stats['active_events']); ?></div>
            </div>
        </div>
...
>>>>>>> feature/statistics
                ...
                <nav class="space-y-1">
                    <button @click="activeSection = 'clubs'"
                        :class="activeSection === 'clubs' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-400 hover:text-white'"
                        class="w-full flex items-center space-x-3 p-4 rounded-2xl transition-all font-bold">
                    ...
                    <button @click="activeSection = 'students'"
                        :class="activeSection === 'students' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-400 hover:text-white'"
                        class="w-full flex items-center space-x-3 p-4 rounded-2xl transition-all font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button @click="activeSection = 'logs'"
                        :class="activeSection === 'logs' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-400 hover:text-white'"
                        class="w-full flex items-center space-x-3 p-4 rounded-2xl transition-all font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <main class="flex-grow space-y-8">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div
                    ...
                    <div class="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-2">Reviews</div>
                    <!-- <div class="text-3xl font-bold text-yellow-500"><?php echo e($stats['pending_reviews']); ?></div> -->
                </div>
                <div
            ...
            <div x-show="activeSection === 'clubs'" class="space-y-6 animate-fadeIn">
                <div class="flex justify-between items-end">
                    <h2 class="text-3xl font-bold">Platform Clubs <span
                            class="text-slate-500 text-lg">(<?php echo e(count($clubs ?? [])); ?>)</span></h2>
                    <div class="text-xs text-slate-500 italic">Target: 4-6 clubs per establishment</div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <?php $__currentLoopData = $clubs ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $club): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="glass p-6 rounded-3xl border border-slate-800 relative overflow-hidden group hover:border-blue-500/40 transition-all cursor-pointer"
                            onclick="window.location.href='<?php echo e($base_url ?? ''); ?>/dashboard/admin/club/<?php echo e($id); ?>'">
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="relative shrink-0">
                                        <div
                                            ...
                                            <img src="<?php echo e($base_url ?? ''); ?>/<?php echo e($imagePath); ?>" alt="<?php echo e($nom); ?>"
                                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                                        </div>
                                        <div
                                            class="absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-slate-900 <?php echo e($isFull && $max > 0 ? 'bg-red-500' : 'bg-green-500'); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-500 mt-1 uppercase tracking-tighter">
                                            President:
                                            <span class="<?php echo e($presidentId ? 'text-slate-300' : 'text-yellow-500'); ?> font-bold">
                                                <?php echo e($presidentName); ?>
                            ...
                            <div class="space-y-4 relative z-10">
                                <div class="space-y-2">
                                    <div
                                        ...
                                        <span>Members Capacity</span>
                                        <span class="<?php echo e($isFull && $max > 0 ? 'text-red-400' : 'text-blue-400'); ?>">
                                            <?php echo e($current); ?> / <?php echo e($max); ?>

                                        </span>
                                    </div>
                                    <div class="w-full bg-slate-800 h-2 rounded-full overflow-hidden flex">
                                        <div class="h-full <?php echo e($isFull && $max > 0 ? 'bg-red-500' : 'bg-blue-500'); ?>"
                                            style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                </div>
                                <div class="flex justify-between items-center mt-4 border-t border-slate-800 pt-3">
                                    <span class="text-[10px] text-slate-500">Created: <?php echo e($displayDate); ?></span>
                                    <span
            ...
            <div x-show="activeSection === 'students'"
                class="glass p-8 rounded-3xl border border-slate-800 animate-fadeIn overflow-hidden">
                <div class="flex justify-between items-center mb-10">
                    ...
                    <div class="flex bg-slate-900 rounded-xl p-1 border border-slate-800">
                        <input type="text" placeholder="Search student..."
                            class="bg-transparent px-4 py-2 text-sm text-white focus:outline-none w-48">
                        <button class="bg-blue-600 p-2 rounded-lg text-white"><svg class="w-4 h-4" fill="none"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead>
                            <tr
                                class="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] border-b border-slate-800">
                                ...
                                <tr class="hover:bg-slate-800/30 transition-colors group">
                                    <td class="py-6">
                                        <div class="flex items-center space-x-3">
                                            <div
                                                class="w-10 h-10 rounded-full bg-slate-800 border-2 border-slate-700 flex items-center justify-center">
                                    ...
                                    <td class="py-6">
                                        <span
                                            class="px-3 py-1 rounded-full text-[10px] font-black uppercase <?php echo e($student['club'] === 'None' ? 'bg-slate-800 text-slate-500' : 'bg-blue-600/10 text-blue-400 border border-blue-500/20'); ?>">
                                    ...
                                    <td class="py-6">
                                        <div class="flex items-center space-x-4">
                                            <button
                                                @click="$dispatch('toast', { message: 'Student profile updated', type: 'success' })"
                                                class="text-blue-400 hover:underline text-xs font-bold uppercase tracking-widest">Edit</button>
                                            <button
                                                @click="$dispatch('toast', { message: 'Student banned from platform', type: 'error' })"
                                                class="text-red-900 font-bold text-xs uppercase hover:text-red-500 transition-colors">Ban</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div x-show="activeSection === 'logs'" class="glass p-8 rounded-3xl border border-slate-800 animate-fadeIn">
                ...
                <div class="space-y-3 font-mono text-xs text-slate-400">
                    ...
                    <div class="p-3 bg-slate-900/80 rounded-xl border border-slate-800 flex items-center">
                        ...
                        <span class="text-slate-500 mr-4"><?php echo e(date('H:i:s', strtotime('-5 mins'))); ?></span>
                        <span>New club "Gaming Hub" successfully created.</span>
                    </div>
                    <div class="p-3 bg-slate-900/80 rounded-xl border border-slate-800 flex items-center">
                        <span class="text-yellow-500 mr-4">[WARNING]</span>
                        <span class="text-slate-500 mr-4"><?php echo e(date('H:i:s', strtotime('-12 mins'))); ?></span>
