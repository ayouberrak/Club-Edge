                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <?php $__currentLoopData = $clubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $club): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="glass p-6 rounded-3xl border border-slate-800 relative overflow-hidden group hover:border-blue-500/40 transition-all cursor-pointer"
                            onclick="window.location.href='<?php echo e($base_url); ?>/dashboard/admin/club/<?php echo e($club['id']); ?>'">
                            <div class="flex justify-between items-start mb-8 relative z-10">
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 mt-1 uppercase tracking-tighter">President: <span
                                            class="text-slate-300 font-bold"><?php echo e($club['president']); ?></span></p>
                                </div>
                            ...
                            <div class="space-y-4 relative z-10">
                                <div class="space-y-2">
                                    <div
                                        ...
                                        <span
                                            class="<?php echo e($club['members'] >= $club['capacity'] ? 'text-red-400' : 'text-blue-400'); ?>"><?php echo e($club['members']); ?>

                                            / <?php echo e($club['capacity']); ?></span>
                                    </div>
                                    <div class="w-full bg-slate-800 h-2 rounded-full overflow-hidden flex">
                                        <div class="h-full <?php echo e($club['status'] === 'full' ? 'bg-red-500' : 'bg-blue-500'); ?>"
                                            style="width: <?php echo e(($club['members'] / $club['capacity']) * 100); ?>%"></div>
                                    </div>
                                </div>
